...
public final class Job implements Progress {
     ...
     * @param jobName Short description of this job
    ...
    /**
     * The amount of extra time if the predicted time was off and more time is
     * needed.
     */
    ...
    /**
     * When did this job start? Measured in milliseconds since beginning of
     * epoch.
     */
