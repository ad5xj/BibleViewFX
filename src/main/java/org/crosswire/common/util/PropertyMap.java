...
public class PropertyMap extends LinkedHashMap<String, String> {
     ...
     * {@link java.util.Properties#load(java.io.InputStream) load(InputStream)}
     * and is assumed to use the ISO 8859-1 character encoding; that is each
     ...
     * <p>
     * Properties from the defaults table of this <code>PropertyMap</code> table
