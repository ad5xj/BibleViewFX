...
public final class CWProject {
     ...
     * @param homeDir the name of the directory to be used for Unix. Typically
     * this is a hidden directory, that is, it begins with a '.'. Defaults to
     * .jsword
     * @param altHomeDir the name of the directory to be used for other OSes.
     * This should not be a hidden directory. Defaults to JSword.
     */
    ...
    /**
     * Sets the name of the front-end. This then informs the read/write
     * directory of the front-end.
     *
     * @param frontendName
     */
    ...
    /**
     * @return the writable home for the front-end settings, that can be kept
     * separate from JSword's configuration, as well from other front-ends.
     */
    ...
    /**
     * @return the readable home for the front-end settings, that can be kept
     * separate from JSword's configuration, as well from other front-ends.
     */
     ...
     * @param extension The extension, prefixed with a '.' See: {@link FileUtil}
     * for a list of popular extensions.
    ...
    /**
     * The name of the front-end application. This allows front-ends to store
     * information under the jsword directory, separate from other front-ends
     */
    ...
    /**
     * Front-end home, where the app can write information to it. Could be null
     * if failed to create
     */
