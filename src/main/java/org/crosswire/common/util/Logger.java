...
/**
 * @brief This class is very similar to Commons-Logging
 * @details 
 ...
 * The &copy;copyright to this program is held by it's authors.
...
public final class Logger {
     ...
     *
     * @param clazz the class that holds the logger.
     * @param showLocation when true it will get the method and line where
     * logging occurred.
     */
     ...
     *
     * @param msg the message to log.
     * @param th the exception to note when not null
     */
     ...
     *
     * @param lev the level at which to log.
     * @param msg the message to log.
     */
    ...
    /**
     * Create a logger for the class. Wrapped by
