 ...
 * @brief Get defaults for Catholic version part 2
 * 
...
public class SystemCatholic2 extends Versification 
{
    ...
    private static final BibleBook[] BOOKS_OT = SystemCatholic.BOOKS_OT;
    ...
    private static final int[][] LAST_VERSE_NT = SystemCatholic.LAST_VERSE_NT;
    ...
    SystemCatholic2()
    {
        super("Catholic2", BOOKS_OT, BOOKS_NT, LAST_VERSE_OT, LAST_VERSE_NT);
    }
}