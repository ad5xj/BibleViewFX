 ...
 * @brief Get defaults for LXX Bible
 * 
...
public class SystemLXX extends Versification 
{
    ...
    private static final BibleBook[] BOOKS_OT = new BibleBook[]
    {
        ...
        BibleBook.KGS1, BibleBook.KGS2, BibleBook.CHR1, BibleBook.CHR2, BibleBook.ESD1, BibleBook.EZRA, BibleBook.NEH, BibleBook.ESTH, BibleBook.JDT, BibleBook.TOB,
        BibleBook.MACC1, BibleBook.MACC2, BibleBook.MACC3, BibleBook.MACC4, BibleBook.PS, BibleBook.PR_MAN, BibleBook.PROV, BibleBook.ECCL, BibleBook.SONG, BibleBook.JOB,
        BibleBook.WIS, BibleBook.SIR, BibleBook.PSALM_SOL, BibleBook.HOS, BibleBook.AMOS, BibleBook.MIC, BibleBook.JOEL, BibleBook.OBAD, BibleBook.JONAH, BibleBook.NAH,
        BibleBook.HAB, BibleBook.ZEPH, BibleBook.HAG, BibleBook.ZECH, BibleBook.MAL, BibleBook.ISA, BibleBook.JER, BibleBook.BAR, BibleBook.LAM, BibleBook.EP_JER,
        BibleBook.EZEK, BibleBook.PR_AZAR, BibleBook.SUS, BibleBook.DAN, BibleBook.BEL, BibleBook.EN1, BibleBook.ODES
    };

    private static final BibleBook[] BOOKS_NT = SystemDefault.BOOKS_NT;

    private static final int[][] LAST_VERSE_OT = new int[][]
    {
        {
    ...
    private static final int[][] LAST_VERSE_NT = new int[][]
    {
        {
    ...
    SystemLXX()
    {
        super("LXX", BOOKS_OT, BOOKS_NT, LAST_VERSE_OT, LAST_VERSE_NT);
    }
