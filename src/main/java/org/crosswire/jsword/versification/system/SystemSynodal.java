...
public class SystemSynodal extends Versification {
    ...
    SystemSynodal() {
        super("Synodal", BOOKS_OT, BOOKS_NT, LAST_VERSE_OT, LAST_VERSE_NT);
    }

    static final BibleBook[] BOOKS_OT = new BibleBook[]{
        ...
        BibleBook.KGS1, BibleBook.KGS2, BibleBook.CHR1, BibleBook.CHR2, BibleBook.PR_MAN, BibleBook.EZRA, BibleBook.NEH, BibleBook.ESD1, BibleBook.TOB, BibleBook.JDT,
        BibleBook.ESTH, BibleBook.JOB, BibleBook.PS, BibleBook.PROV, BibleBook.ECCL, BibleBook.SONG, BibleBook.WIS, BibleBook.SIR, BibleBook.ISA, BibleBook.JER,
        BibleBook.LAM, BibleBook.EP_JER, BibleBook.BAR, BibleBook.EZEK, BibleBook.DAN, BibleBook.HOS, BibleBook.JOEL, BibleBook.AMOS, BibleBook.OBAD, BibleBook.JONAH,
        BibleBook.MIC, BibleBook.NAH, BibleBook.HAB, BibleBook.ZEPH, BibleBook.HAG, BibleBook.ZECH, BibleBook.MAL, BibleBook.MACC1, BibleBook.MACC2, BibleBook.MACC3,
        BibleBook.ESD2};

    static final BibleBook[] BOOKS_NT = new BibleBook[]{
        BibleBook.MATT, BibleBook.MARK, BibleBook.LUKE, BibleBook.JOHN, BibleBook.ACTS, BibleBook.JAS, BibleBook.PET1, BibleBook.PET2, BibleBook.JOHN1, BibleBook.JOHN2,
        BibleBook.JOHN3, BibleBook.JUDE, BibleBook.ROM, BibleBook.COR1, BibleBook.COR2, BibleBook.GAL, BibleBook.EPH, BibleBook.PHIL, BibleBook.COL, BibleBook.THESS1,
        BibleBook.THESS2, BibleBook.TIM1, BibleBook.TIM2, BibleBook.TITUS, BibleBook.PHLM, BibleBook.HEB, BibleBook.REV};

    static final int[][] LAST_VERSE_OT = new int[][]{
        {
            ...
            22, 51, 39, 25},
        {
            ...
            21, 33, 25, 33, 27, 23}, {12}, {11, 70, 13, 24, 17, 22, 28, 36, 15, 44}, {
            11, 20, 32, 23, 19, 19, 73, 18, 38, 39,
            36, 47, 31}, {58, 31, 24, 63, 70, 34, 15, 92, 55}, {
        ...
        {22, 23, 15, 17, 14, 14, 10, 17, 32, 3}, {
            ...
            64, 34},
        {22, 22, 66, 22, 22}, {72}, {22, 35, 38, 37, 9}, {
    ...
    static final int[][] LAST_VERSE_NT = new int[][]{
        {
            ...
            40, 30, 35, 27, 27, 32, 44, 31}, {27, 26, 18, 17, 20}, {25, 25, 22, 19, 14}, {21, 22, 18}, {10, 29, 24, 21, 21}, {13},
        {15}, {25}, {
            ...
            32, 21, 13}, {24, 21, 29, 31, 26, 18}, {23, 22, 21, 32, 33, 24}, {30, 30, 21, 23}, {29, 23, 25, 18}, {10, 20, 13, 18, 28},
        {12, 17, 18}, {20, 15, 16, 16, 25, 21}, {18, 26, 17, 22}, {16, 15, 15}, {25}, {
