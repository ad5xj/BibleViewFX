...
public class SystemNRSVA extends Versification {
    ...
    SystemNRSVA() {
        super("NRSVA", BOOKS_OT, BOOKS_NT, LAST_VERSE_OT, LAST_VERSE_NT);
    }
    ...
    static final BibleBook[] BOOKS_OT = new BibleBook[]{
        ...
        BibleBook.OBAD, BibleBook.JONAH, BibleBook.MIC, BibleBook.NAH, BibleBook.HAB, BibleBook.ZEPH, BibleBook.HAG, BibleBook.ZECH, BibleBook.MAL, BibleBook.TOB,
        BibleBook.JDT, BibleBook.ESTH_GR, BibleBook.WIS, BibleBook.SIR, BibleBook.BAR, BibleBook.PR_AZAR, BibleBook.SUS, BibleBook.BEL, BibleBook.MACC1, BibleBook.MACC2,
        BibleBook.ESD1, BibleBook.PR_MAN, BibleBook.ADD_PS, BibleBook.MACC3, BibleBook.ESD2, BibleBook.MACC4};
    ...
    static final int[][] LAST_VERSE_OT = new int[][]{
            ...
            31},
        {
            ...
            12, 14, 16, 9}, {20, 32, 21}, {15, 16, 15, 13, 27, 14, 17, 14, 15},
        {21}, {17, 10, 10, 11}, {16, 13, 12, 13, 15, 16, 20}, {15, 13, 19}, {17, 20, 19}, {18, 15, 20}, {15, 23}, {
