 ...
 * @brief Get default values for German Bible
 * 
...
public class SystemGerman extends Versification 
{
    ...
    private static final BibleBook[] BOOKS_OT = SystemDefault.BOOKS_OT;
    ...
    SystemGerman()
    {
        super("German", BOOKS_OT, BOOKS_NT, LAST_VERSE_OT, LAST_VERSE_NT);
    }
}