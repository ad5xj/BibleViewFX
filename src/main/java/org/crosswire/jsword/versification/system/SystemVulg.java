...
public class SystemVulg extends Versification {
    ...
    SystemVulg() {
        super("Vulg", BOOKS_OT, BOOKS_NT, LAST_VERSE_OT, LAST_VERSE_NT);
    }
    ...
    static final BibleBook[] BOOKS_OT = new BibleBook[]{
        ...
        BibleBook.KGS1, BibleBook.KGS2, BibleBook.CHR1, BibleBook.CHR2, BibleBook.EZRA, BibleBook.NEH, BibleBook.TOB, BibleBook.JDT, BibleBook.ESTH, BibleBook.JOB,
        BibleBook.PS, BibleBook.PROV, BibleBook.ECCL, BibleBook.SONG, BibleBook.WIS, BibleBook.SIR, BibleBook.ISA, BibleBook.JER, BibleBook.LAM, BibleBook.BAR,
        BibleBook.EZEK, BibleBook.DAN, BibleBook.HOS, BibleBook.JOEL, BibleBook.AMOS, BibleBook.OBAD, BibleBook.JONAH, BibleBook.MIC, BibleBook.NAH, BibleBook.HAB,
        BibleBook.ZEPH, BibleBook.HAG, BibleBook.ZECH, BibleBook.MAL, BibleBook.MACC1, BibleBook.MACC2};
    ...
    static final BibleBook[] BOOKS_NT = new BibleBook[]{
        ...
        BibleBook.PET1, BibleBook.PET2, BibleBook.JOHN1, BibleBook.JOHN2, BibleBook.JOHN3, BibleBook.JUDE, BibleBook.REV, BibleBook.PR_MAN, BibleBook.ESD1, BibleBook.ESD2,
        BibleBook.ADD_PS, BibleBook.EP_LAO};
    ...
    static final int[][] LAST_VERSE_OT = new int[][]{
            ...
            22, 51, 39, 25},
        {
            ...
            21, 33, 25, 33, 27, 23}, {11, 70, 13, 24, 17, 22, 28, 36, 15, 44}, {
            ...
            25, 16},
        {
            ...
            64, 34}, {22, 22, 66, 22, 22}, {22, 35, 38, 37, 9, 72},
        {
            ...
            12, 14, 15, 10}, {20, 32, 21}, {15, 16, 15, 13, 27, 15, 17, 14, 15}, {21}, {16, 11, 10, 11}, {16, 13, 12, 13, 14, 16, 20}, {15, 13, 19}, {17, 20, 19},
        {18, 15, 20}, {14, 24}, {
    ...
    static final int[][] LAST_VERSE_NT = new int[][]{
        {
            ...
            33, 21, 13}, {24, 21, 29, 31, 26, 18}, {23, 22, 21, 32, 33, 24},
        ...
        {25, 25, 22, 19, 14}, {21, 22, 18}, {10, 29, 24, 21, 21}, {13}, {15}, {25}, {
            ...
            27, 21}, {15}, {58, 31, 24, 63, 73, 34, 15, 97, 56}, {
