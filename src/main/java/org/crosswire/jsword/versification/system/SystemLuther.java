...
public class SystemLuther extends Versification 
{
    ...
    private static final BibleBook[] BOOKS_OT = new BibleBook[]
    {
        ...
        BibleBook.OBAD, BibleBook.JONAH, BibleBook.MIC, BibleBook.NAH, BibleBook.HAB, BibleBook.ZEPH, BibleBook.HAG, BibleBook.ZECH, BibleBook.MAL, BibleBook.JDT,
        BibleBook.WIS, BibleBook.TOB, BibleBook.SIR, BibleBook.BAR, BibleBook.MACC1, BibleBook.MACC2, BibleBook.ADD_ESTH, BibleBook.ADD_DAN, BibleBook.PR_MAN
    };

    private static final BibleBook[] BOOKS_NT = new BibleBook[]
    {
        ...
        BibleBook.PHIL, BibleBook.COL, BibleBook.THESS1, BibleBook.THESS2, BibleBook.TIM1, BibleBook.TIM2, BibleBook.TITUS, BibleBook.PHLM, BibleBook.PET1, BibleBook.PET2,
        BibleBook.JOHN1, BibleBook.JOHN2, BibleBook.JOHN3, BibleBook.HEB, BibleBook.JAS, BibleBook.JUDE, BibleBook.REV
    };
    ...
    SystemLuther()
    {
        super("Luther", BOOKS_OT, BOOKS_NT, LAST_VERSE_OT, LAST_VERSE_NT);
    }
}