...
public class SystemLeningrad extends Versification 
{
    ...
    private static final BibleBook[] BOOKS_OT = new BibleBook[]
    {
        ...
        BibleBook.NAH, BibleBook.HAB, BibleBook.ZEPH, BibleBook.HAG, BibleBook.ZECH, BibleBook.MAL, BibleBook.CHR1, BibleBook.CHR2, BibleBook.PS, BibleBook.JOB,
        BibleBook.PROV, BibleBook.RUTH, BibleBook.SONG, BibleBook.ECCL, BibleBook.LAM, BibleBook.ESTH, BibleBook.DAN, BibleBook.EZRA, BibleBook.NEH
    };

    private static final BibleBook[] BOOKS_NT = SystemDefault.BOOKS_NONE;
    ...
    private static final int[][] LAST_VERSE_NT = SystemDefault.LAST_VERSE_NONE;
    ...
    SystemLeningrad()
    {
        super("Leningrad", BOOKS_OT, BOOKS_NT, LAST_VERSE_OT, LAST_VERSE_NT);
    }
}