...
/**
 * @ingroup org.crossfire.jsword.versification.system
 * @brief Get defaults for KJV
 * 
...
public class SystemKJVA extends Versification 
{
    ...
    private static final BibleBook[] BOOKS_OT = new BibleBook[]
    {
        ...
        BibleBook.OBAD, BibleBook.JONAH, BibleBook.MIC, BibleBook.NAH, BibleBook.HAB, BibleBook.ZEPH, BibleBook.HAG, BibleBook.ZECH, BibleBook.MAL, BibleBook.ESD1,
        BibleBook.ESD2, BibleBook.TOB, BibleBook.JDT, BibleBook.ADD_ESTH, BibleBook.WIS, BibleBook.SIR, BibleBook.BAR, BibleBook.PR_AZAR, BibleBook.SUS, BibleBook.BEL,
        BibleBook.PR_MAN, BibleBook.MACC1, BibleBook.MACC2
    };
    ...
    private static final int[][] LAST_VERSE_NT = SystemKJV.LAST_VERSE_NT;
