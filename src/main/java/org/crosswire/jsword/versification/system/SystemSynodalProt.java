...
public class SystemSynodalProt extends Versification {
    ...
    SystemSynodalProt() {
        super("SynodalProt", BOOKS_OT, BOOKS_NT, LAST_VERSE_OT, LAST_VERSE_NT);
    }
    ...
    static final int[][] LAST_VERSE_OT = new int[][]{
            ...
            22, 51, 39, 25},
        {
            ...
            36, 47, 31}, {22, 23, 15, 17, 14, 14, 10, 17, 32, 3}, {
            ...
            31},
        {
            ...
            12, 14, 15, 10}, {20, 32, 21}, {15, 16, 15, 13, 27, 14, 17, 14, 15},
        {21}, {16, 11, 10, 11}, {16, 13, 12, 13, 15, 16, 20}, {15, 13, 19}, {17, 20, 19}, {18, 15, 20}, {15, 23}, {
