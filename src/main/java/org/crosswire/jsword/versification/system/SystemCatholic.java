 ...
 * @brief System defaults for Catholic version
 * 
...
public class SystemCatholic extends Versification 
{
    ...
    public static final BibleBook[] BOOKS_OT = new BibleBook[]
    {
        ...
        BibleBook.KGS1, BibleBook.KGS2, BibleBook.CHR1, BibleBook.CHR2, BibleBook.EZRA, BibleBook.NEH, BibleBook.TOB, BibleBook.JDT, BibleBook.ESTH, BibleBook.MACC1,
        BibleBook.MACC2, BibleBook.JOB, BibleBook.PS, BibleBook.PROV, BibleBook.ECCL, BibleBook.SONG, BibleBook.WIS, BibleBook.SIR, BibleBook.ISA, BibleBook.JER,
        BibleBook.LAM, BibleBook.BAR, BibleBook.EZEK, BibleBook.DAN, BibleBook.HOS, BibleBook.JOEL, BibleBook.AMOS, BibleBook.OBAD, BibleBook.JONAH, BibleBook.MIC,
        BibleBook.NAH, BibleBook.HAB, BibleBook.ZEPH, BibleBook.HAG, BibleBook.ZECH, BibleBook.MAL
    };

    public static final BibleBook[] BOOKS_NT = SystemDefault.BOOKS_NT;

    public static final int[][] LAST_VERSE_OT = new int[][]
    {
        {
    ...
    public static final int[][] LAST_VERSE_NT = new int[][]
    {
        {
    ...
    SystemCatholic()
    {
        super("Catholic", BOOKS_OT, BOOKS_NT, LAST_VERSE_OT, LAST_VERSE_NT);
    }
}
