...
public class SystemOrthodox extends Versification {
    ...
    SystemOrthodox() {
        super("Orthodox", BOOKS_OT, BOOKS_NT, LAST_VERSE_OT, LAST_VERSE_NT);
    }
    ...
    static final BibleBook[] BOOKS_OT = new BibleBook[]{
        ...
        BibleBook.KGS1, BibleBook.KGS2, BibleBook.CHR1, BibleBook.CHR2, BibleBook.ESD1, BibleBook.EZRA, BibleBook.NEH, BibleBook.TOB, BibleBook.JDT, BibleBook.ESTH,
        BibleBook.MACC1, BibleBook.MACC2, BibleBook.MACC3, BibleBook.PS, BibleBook.PR_MAN, BibleBook.JOB, BibleBook.PROV, BibleBook.ECCL, BibleBook.SONG, BibleBook.WIS,
        BibleBook.SIR, BibleBook.HOS, BibleBook.AMOS, BibleBook.MIC, BibleBook.JOEL, BibleBook.OBAD, BibleBook.JONAH, BibleBook.NAH, BibleBook.HAB, BibleBook.ZEPH,
        BibleBook.HAG, BibleBook.ZECH, BibleBook.MAL, BibleBook.ISA, BibleBook.JER, BibleBook.BAR, BibleBook.LAM, BibleBook.EP_JER, BibleBook.EZEK, BibleBook.SUS,
        BibleBook.DAN, BibleBook.BEL, BibleBook.MACC4};
    ...
    static final int[][] LAST_VERSE_OT = new int[][]{
            ...
            22, 51, 41, 25},
        {
            ...
            21, 33, 25, 33, 31, 31}, {58, 30, 24, 63, 73, 34, 15, 96, 55}, {11, 70, 13, 24, 17, 22, 28, 36, 15, 44}, {
            ...
            17, 7, 30, 19, 24, 24},
        {
            ...
            38, 46, 26, 46, 39}, {29, 33, 30, 21, 51, 41, 23}, {
            ...
            27, 27, 19, 31, 19, 29, 21, 25, 22},
        {
            ...
            12, 15, 16, 10}, {15, 16, 15, 13, 27, 15, 17, 14, 15}, {16, 13, 12, 14, 15, 16, 20}, {20, 32, 21, 21}, {21}, {17, 11, 10, 11}, {15, 14, 19}, {17, 20, 19}, {18, 15, 21},
        {15, 24}, {
            21, 17, 11, 14, 11, 15, 14, 23, 17, 12,
            17, 14, 9, 21}, {14, 17, 24, 6}, {
