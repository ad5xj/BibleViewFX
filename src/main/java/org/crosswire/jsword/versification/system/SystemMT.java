...
public class SystemMT extends Versification {
    ...
    static final BibleBook[] BOOKS_OT = new BibleBook[]{
        BibleBook.GEN, BibleBook.EXOD, BibleBook.LEV, BibleBook.NUM, BibleBook.DEUT, BibleBook.JOSH, BibleBook.JUDG, BibleBook.SAM1, BibleBook.SAM2, BibleBook.KGS1,
        BibleBook.KGS2, BibleBook.ISA, BibleBook.JER, BibleBook.EZEK, BibleBook.HOS, BibleBook.JOEL, BibleBook.AMOS, BibleBook.OBAD, BibleBook.JONAH, BibleBook.MIC,
        BibleBook.NAH, BibleBook.HAB, BibleBook.ZEPH, BibleBook.HAG, BibleBook.ZECH, BibleBook.MAL, BibleBook.PS, BibleBook.JOB, BibleBook.PROV, BibleBook.RUTH,
        BibleBook.SONG, BibleBook.ECCL, BibleBook.LAM, BibleBook.ESTH, BibleBook.DAN, BibleBook.EZRA, BibleBook.NEH, BibleBook.CHR1, BibleBook.CHR2};

    static final BibleBook[] BOOKS_NT = SystemDefault.BOOKS_NONE;
    ...
    static final int[][] LAST_VERSE_OT = new int[][]{
            ...
            29, 54},
        {
            ...
            11, 15, 15, 10}, {20, 27, 5, 21}, {15, 16, 15, 13, 27, 14, 17, 14, 15}, {21}, {16, 11, 10, 11}, {16, 13, 12, 14, 14, 16, 20},
        {14, 14, 19}, {17, 20, 19}, {18, 15, 20}, {15, 23}, {
        ...
        {17, 17, 11, 16, 16, 12, 14, 14}, {
            ...
            10, 14}, {22, 22, 66, 22, 22}, {22, 23, 15, 17, 14, 14, 10, 17, 32, 3}, {
            21, 49, 33, 34, 30, 29, 28, 27, 27, 21,
            45, 13}, {11, 70, 13, 24, 17, 22, 28, 36, 15, 44}, {
    ...
    static final int[][] LAST_VERSE_NT = SystemDefault.LAST_VERSE_NONE;

    private static final long serialVersionUID = -3679238882055120660L;

    SystemMT() {
        super("MT", BOOKS_OT, BOOKS_NT, LAST_VERSE_OT, LAST_VERSE_NT);
    }
}
